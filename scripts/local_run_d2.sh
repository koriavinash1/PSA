...
# do
#     LOGSDIR="/vol/biomedic3/agk21/CoSA/SAModelling/LOGS-RandomSeeds/NoAdditiveDecoders/$HPS"
...
#             CUDA_VISIBLE_DEVICE=0 python $RUNCMD &
#         done
#         wait
#     done
# done
    ...
    do
        ...
        do
            RUNCMD="/vol/biomedic3/agk21/CoSA/SAModelling/main.py \
                    ...
                    --run_idx $RUN"
            echo $RUNCMD
            CUDA_VISIBLE_DEVICE=1 python $RUNCMD &
        done
        wait
    done
done